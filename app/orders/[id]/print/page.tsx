    ...
    return (
        <div className="min-h-screen bg-gray-100 p-8 font-sans print:bg-white print:p-0">
            <div className="max-w-[210mm] mx-auto mb-6 flex gap-4 print:hidden" dir="rtl">
                <PrintButton />
                <a href="/" className="bg-gray-500 text-white px-8 py-3 rounded-lg font-bold flex items-center">🏠 خروج</a>
            </div>

            <div className="max-w-[210mm] mx-auto bg-white p-10 shadow-2xl print:shadow-none print:w-full" dir="rtl">
                    ...
                    <table className="w-full text-base">
                        <tbody>
                            <tr>
                                ...
                                <td className="text-xl">{order.customer.name}</td>
                                <td className="font-bold w-24 text-left pl-4">الهاتف:</td>
                ...
                <div className="flex justify-end mb-16">
                    <div className="w-1/2 border-2 border-black rounded-lg overflow-hidden">
                        ...
                        {deposit > 0 && (
                            <div className="flex justify-between p-2 border-b border-black bg-white font-bold text-gray-700">
                                <span>مدفوع (عربون):</span>
                                <span>- {deposit.toFixed(2)} ج.م</span>
                            </div>
                        )}
                        <div className="flex justify-between p-4 bg-black text-white text-2xl font-bold">
