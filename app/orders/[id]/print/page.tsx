...
export default async function OrderPrintPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="bg-gray-100 min-h-screen" dir="rtl">
      ...
      <div id="printable-area" className="bg-white text-gray-800 p-8 font-sans text-sm max-w-4xl mx-auto my-8 shadow-lg border-t-8 border-blue-600">
        ...
        {/* --- Footer & Totals --- */}
        <footer className="flex justify-between items-start pt-6 border-t-2 border-gray-200">
